...
'INSTANT VB NOTE: The variable persons was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable isMarried was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable dataError was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private dataError_Renamed As String = ""
'INSTANT VB NOTE: The variable dataErrors was renamed since Visual Basic does not allow variables and other class members to have the same name:
